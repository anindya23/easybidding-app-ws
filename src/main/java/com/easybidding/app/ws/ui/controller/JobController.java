...
public class JobController {
	...
	public List<JobAccountDto> getAllJobsByAccountAndStatus(@PathVariable String accountId, @PathVariable String status) {
		return jobService.getAllJobsByAccountAndStatus(accountId, status);
	}

	@GetMapping("/user/{email}/status/{status}")
	public List<JobAccountDto> getAllJobsByUserAndStatus(@PathVariable String email, @PathVariable String status) {
	...
	@PutMapping("/jobaccount")
	public JobAccountDto changeJobStatus(@Valid @RequestBody JobAccountDto request) throws ParseException {
		return jobService.changeJobStatus(request);
	}
...
//	}
	...
	@DeleteMapping("/jobaccount/{id}")
	public OperationStatusModel deleteAccountJob(@PathVariable(value = "id") String id) {
		OperationStatusModel response = new OperationStatusModel();
		response.setOperationName(RequestOperationName.DELETE.name());

		jobService.removeAccountJob(id);
